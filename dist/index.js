...
Object.defineProperty(exports, "PrintGrid", {
  enumerable: true,
  get: function get() {
    return _PrintGrid["default"];
  }
});
Object.defineProperty(exports, "PrintGridEmpty", {
  enumerable: true,
  get: function get() {
    return _PrintGridEmpty["default"];
  }
});
...
var _PrintGrid = _interopRequireDefault(require("./PrintGrid"));
var _PrintGridEmpty = _interopRequireDefault(require("./PrintGridEmpty"));
...
var Print = function Print(_ref) {
  ...
  var gridContainer = (0, _react.useRef)();
  var tempColumn = columnList;
  var pObj = {};
  tempColumn.forEach(function (item) {
    pObj[item.field] = true;
  });
  var _useState9 = (0, _react.useState)(printSetting || pObj),
  ...
  var AddSize = function AddSize() {
    if (fontSize <= 25) {
      setFontSize(fontSize + 1);
    }
  };
  var DecreaseSize = function DecreaseSize() {
    if (fontSize >= 9) {
      setFontSize(fontSize - 1);
    }
  };
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return timeout(500);
          case 2:
            setGridW((gridContainer === null || gridContainer === void 0 || (_gridContainer$curren = gridContainer.current) === null || _gridContainer$curren === void 0 ? void 0 : _gridContainer$curren.offsetWidth) - 20);
          case 3:
          case "end":
  ...
  (0, _react.useEffect)(function () {
    var _gridContainer$curren2;
    setGridW((gridContainer === null || gridContainer === void 0 || (_gridContainer$curren2 = gridContainer.current) === null || _gridContainer$curren2 === void 0 ? void 0 : _gridContainer$curren2.offsetWidth) - 20);
  }, []);
  return /*#__PURE__*/_react["default"].createElement("div", {
    className: "p-3 print-page"
    ...
    className: "header-print-grid"
  }, /*#__PURE__*/_react["default"].createElement("div", {
    className: "row mb-0"
  }, /*#__PURE__*/_react["default"].createElement("div", {
    className: "col-lg-4 col-md-4 col-4 m-0"
    ...
    className: "icons"
  }, showZoom ? /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_material.Button, {
    className: "iconButton ",
    onClick: function onClick() {
      return DecreaseSize();
    }
  }, /*#__PURE__*/_react["default"].createElement(_ZoomOut["default"], null)), /*#__PURE__*/_react["default"].createElement(_material.Button, {
    className: "iconButton",
    onClick: function onClick() {
      return AddSize();
    }
    ...
    if (!(column !== null && column !== void 0 && (_column$children = column.children) !== null && _column$children !== void 0 && _column$children.length)) {
      return fields[column.field] && /*#__PURE__*/_react["default"].createElement(_kendoReactGrid.GridColumn, _extends({}, column, {
        key: index,
        title: t("".concat(column.name))
      }));
    } else {
      return fields[column.field] && /*#__PURE__*/_react["default"].createElement(_kendoReactGrid.GridColumn, _extends({
        key: index
      }, column, {
        title: t("".concat(column.name))
      }), column === null || column === void 0 ? void 0 : column.children.map(function (children, indexC) {
        return /*#__PURE__*/_react["default"].createElement(_kendoReactGrid.GridColumn, _extends({}, children, {
          key: indexC,
          title: t("".concat(children.name))
        }));
      }));
    }
  })))))))))));
